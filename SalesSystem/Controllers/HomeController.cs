...
namespace SalesSystem.Controllers
{
    public class HomeController : Controller
    {
        ...
        //{
        //    List<TUsers> users = _context.TUsers.ToList();
        //    return View(users); 
        //}
        ...
        public IActionResult Friends_Activities()
        {
            return View();
        }

        public IActionResult Beer_History()
        {
            return View();
        }

        public IActionResult Beer_Place()
        {
            return View();
        }
        ...
        //    userCreateModel.Users = new TUsers();
        //    List<SelectListItem> countries = _context.Countries.OrderBy(n => n.NameEN)
        //        .Select(n => new SelectListItem {
        //        Value = n.CountryId,
        //        Text = n.NameEN
        //        }).ToList();

        //    userCreateModel.Country = countries;
