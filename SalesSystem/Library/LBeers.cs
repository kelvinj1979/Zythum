...
{
    public class LBeers : ListObject
    {
		private ApplicationDbContext context;

		public LBeers(ApplicationDbContext context)
		{
			_context = context;
		}

		public LBeers(UserManager<IdentityUser> userManager, ApplicationDbContext context)
        {
