    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapAreaControllerRoute("Brewery", "Brewery", "{controller=Brewery}/{action=Brewery}/{id?}");

                endpoints.MapAreaControllerRoute("Beers", "Beers", "{controller=Beers}/{action=Beers}/{id?}");
